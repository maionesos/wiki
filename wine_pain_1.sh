...
case "$decision1" in
   ...
   "mtu")
		...
		;;
   "ttis")
		scp -O -P $inputval2 -o "StrictHostKeyChecking=no" -i /home/user/key/medkey -r /home/user/kva-kva/med_linux/tis/$tis_gz root@$inputval:/tmp/
	...
	"srantum")
		...
		;;
	"woo")
		scp -O -P $inputval2 -o "StrictHostKeyChecking=no" -i /home/user/key/medkey -r /home/user/kva-kva/med_linux/word/Star_wine.tar.gz root@$inputval:/tmp/
		...
		;;
	"sprecord")
		scp -O -P $inputval2 -o "StrictHostKeyChecking=no" -i /home/user/key/medkey -r /home/user/kva-kva/sprecord/sprecord-1.2.0.151-alt1.repacked.with.epm.2.x86_64.rpm root@$inputval:/tmp/
		...
		;;
	"exp")
		scp -O -P $inputval2 -o "StrictHostKeyChecking=no" -i /home/user/key/medkey /home/user/kva-kva/med_linux/Expert.tar.gz root@$inputval:/tmp/
		...
		;;
	"lpu")
		scp -O -P $inputval2 -o "StrictHostKeyChecking=no" -i /home/user/key/medkey -r /home/user/kva-kva/med_linux/lpu/ root@$inputval:/tmp/
